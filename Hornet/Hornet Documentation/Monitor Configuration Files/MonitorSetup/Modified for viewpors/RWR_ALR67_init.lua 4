...
if bakeIndicators == true then
	...
	shaderLineDefaultFuzziness = 0.015
	--shaderLineDefaultThickness = 1.8  -- omer : original DCS
	--shaderLineDefaultFuzziness = 0.4  -- omer : original DCS
	...
	shaderLineParamsUpdatable  = true
	haderLineDefaultThickness = 0.05
	shaderLineDefaultFuzziness = 0.015
	--shaderLineDefaultThickness = 0.8	-- omer : original DCS
	--shaderLineDefaultFuzziness = 0.4	-- omer : original DCS
	shaderLineDrawAsWire 	   = false
	shaderLineUseSpecularPass  = true
