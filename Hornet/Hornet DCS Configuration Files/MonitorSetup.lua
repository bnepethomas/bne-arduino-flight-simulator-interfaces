...
LEFT_MFCD = { x = 12363, y = 0 + 35 , width = 498, height = 538 }
RIGHT_MFCD = { x = 11991, y = 829, width = 498, height = 538 }
F18_RWR = { x = 11520+1024, y = 800 , width = 430, height = 450 }
F18_UFC = { x = 11522  , y = 0, width = 2, height = 2 }
F18_IFEI = { x = 11520-480, y = 1420, width = 1480, height = 590 }
