...
20150228b - Buildng multiple Stepper card support
...
//  
  		...
  		//GotoMinPort1();
            ...
            Serial.println("Pausing before cycling 4");  
                delay(StartUpDelayBetweenSteps);
                Serial.println("Start 4 Max");
                GotoMaxPort4();
                Serial.println("Finished 4 Max");
                delay(StartUpDelayBetweenSteps);
                Serial.println("Start 4 Min");
                GotoMinPort4();
                Serial.println("Finished 4 Min");
               
            Serial.println("Pausing before cycling 8");  
                delay(StartUpDelayBetweenSteps);
                Serial.println("Start 8 Max");
                GotoMaxPort8();
                Serial.println("Finished 8 Max");
                delay(StartUpDelayBetweenSteps);
                Serial.println("Start 8 Min");
                GotoMinPort8();
                Serial.println("Finished 8 Min");               
	}       
...
// Turning Counter Clockwise
{
	for( int i = 0; i < 320 * StepsPerDegree; i++)
	{
		sendCmdTo595_2( B00000000 ); //Working returning to zero
		sendCmdTo595_2( B01000000 );
		delayMicroseconds(250);
	}
...
// Turning Clockwise
{
	...
	{		
                ...
                sendCmdTo595_2( B10101010 );
 		sendCmdTo595_2( B11000000 );
        	delayMicroseconds(250);
	}
...
// Turning Counter Clockwise
{
	for( int i = 0; i < 320 * StepsPerDegree; i++)
	{
		sendCmdTo595_3( B00000000 ); //Working returning to zero
		sendCmdTo595_3( B01000000 );
		delayMicroseconds(250);
	}
...
// Turning Clockwise
{
	...
	{		
                ...
                sendCmdTo595_3( B10101010 );
 		sendCmdTo595_3(B11000000 );
        	delayMicroseconds(250);
	}
