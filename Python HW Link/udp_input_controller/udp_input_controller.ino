...
void sendJoyReport(struct joyReport_t *report)
{
  ...
  //{
    ...
    Serial.println("why is 65 always on?");
...
//      if (joyReport.button[buttonid] == 1 && buttonid != 65)
//      {
//        sprintf(cButtonID, "%3d", buttonid);
//        Serial.println(cButtonID);
//        delay(100);
//      }
...
// Commented out Encoder until stadard switch testing is complete 20180624
  //scan rotary encoder
