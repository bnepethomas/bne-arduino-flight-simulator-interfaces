...
# DCS-Keystroke-PyHWLink_Pri_Node_Input.py
# Based on PyHWLink_Pri_Node_Input.py - split 20190120
#    Will keep the same receive ports as original code as there
#        should only be a single Sim running at a point in time

# Receives AV pairs from input devices and translates to keystrokes for the sim
# Will send Key Codes which means from form of translation is going to be needed
#    for input values
# Needs to consider multi-keystroke commands eg Alt-F1, and possibly multi commands
# 
...
# 
if not (os.path.isfile('DCS-Keystroke-input_config.py')):
    
    print('Unable to find DCS-Keystroke-input_config.py')
...
# Changed reflect DCS Keystroke - only a single set of bindings are used for all aircraft
#
input_assignments_file = 'DCS-Keystroke-input_assignments.json'
temp_input_assignments_file = 'DCS-Keyatroke-temp_input_assignments.json'
