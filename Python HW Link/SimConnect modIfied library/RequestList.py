...
class AircraftRequests():
	...
	class __AircraftEngineData(RequestHelper):
		list = {
            ...
            #BNEPETHOMAS additions
            "NEW_FUEL_SYSTEM": ["The stage of the afterburner, or 0 if the afterburner is not active.", b'NEW FUEL SYSTEM', b'Number', 'N'],
            "FUELSYSTEM_VALVE_OPEN:index": ["The stage of the afterburner, or 0 if the afterburner is not active.", b'FUELSYSTEM VALVE OPEN', b'Number', 'N'],
            "FUELSYSTEM_VALVE_SWITCH:index": ["The stage of the afterburner, or 0 if the afterburner is not active.", b'FUELSYSTEM VALVE SWITCH', b'Number', 'N'],
            "FUELSYSTEM_TANK_TOTAL_QUANTITY:index": ["The stage of the afterburner, or 0 if the afterburner is not active.", b'FUELSYSTEM TANK TOTAL QUANTITY', b'Number', 'N'],
