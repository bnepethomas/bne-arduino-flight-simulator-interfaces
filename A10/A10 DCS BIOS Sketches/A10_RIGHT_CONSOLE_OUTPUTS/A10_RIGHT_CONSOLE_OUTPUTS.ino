/*
A10_RIGHT_CONSOLE_OUTPUTS

Drives:

AccelStepper STEPPER_LEFT_HYD
AccelStepper STEPPER_RIGHT_HYD
AccelStepper STEPPER_LEFT_FUEL
AccelStepper STEPPER_RIGHT_FUEL
AccelStepper STEPPER_OXY_REG
AccelStepper STEPPER_LOX
AccelStepper STEPPER_CABIN_PRESS

WARNING PANEL (Max7219)
...
byte mac[] = { 0xA8, 0x61, 0x0A, 0x67, 0x83, 0x07 };
String sMac = "A8:61:0A:67:83:07";
IPAddress ip(172, 16, 1, 107);
String strMyIP = "172.16.1.107";
