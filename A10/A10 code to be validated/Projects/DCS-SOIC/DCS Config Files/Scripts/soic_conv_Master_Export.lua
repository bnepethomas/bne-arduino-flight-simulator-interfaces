...
-- The complete export script before being thrown into separate files
...
function LuaExportBeforeNextFrame()
	...
	-- TX Data
	---------------------------------------------------
	for i = 1, #soic_conv_flightData do soic_conv_packet = soic_conv_packet .. soic_conv_flightData[i] .. ":" end
