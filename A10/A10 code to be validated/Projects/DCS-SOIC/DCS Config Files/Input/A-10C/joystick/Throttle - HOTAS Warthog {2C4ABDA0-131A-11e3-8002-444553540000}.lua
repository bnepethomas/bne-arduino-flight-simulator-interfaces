...
{down = iCommandEmergencyGear, name = "Auxiliary gear handle", category = "Landing gear panel"},
...
{combos = {{key = "JOY_BTN24"}, }, down = iCommandPlane_EAC_ARM, up = iCommandPlane_EAC_OFF, name = "EAC Arm/Off", category = "LASTE Control Panel"},
...
{down = iCommandPlaneEmergencyDisconnectLever, up = iCommandPlaneEmergencyDisconnectLever, name = "Emergency Disconnect Lever", category = "HOTAS"},
{down = iCommandPlaneEmergencyBrake, up = iCommandPlaneEmergencyBrake, name = "Emergency Wheel Brake", category = "Systems"},
{down = iCommandEmergencyFlood, name = "Emergency flood", category = "Electrical power control panel"},
{down = iCommand_ExplorationStart, name = "Enable visual recon mode", category = "View Cockpit"},
...
{down = iCommandPlaneFlapsOn, name = "Flaps Down", category = "Systems"},
...
{down = iCommandPlaneLeftStart, up = iCommandPlaneLeftStop, name = "Fly: Left Wing Down", category = "Flight Control"},
{down = iCommandPlaneUpStart, up = iCommandPlaneUpStop, name = "Fly: Nose Down", category = "Flight Control"},
{down = iCommandPlaneDownStart, up = iCommandPlaneDownStop, name = "Fly: Nose Up", category = "Flight Control"},
{down = iCommandPlaneRightStart, up = iCommandPlaneRightStop, name = "Fly: Right Wing Down", category = "Flight Control"},
{down = iCommandPlaneLeftRudderStart, up = iCommandPlaneLeftRudderStop, name = "Fly: Rudder Left", category = "Flight Control"},
{down = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop, name = "Fly: Rudder Right", category = "Flight Control"},
...
{down = iCommandPlane_HOTAS_TriggerSecondStage, up = iCommandPlane_HOTAS_TriggerSecondStage_Off, name = "Gun Trigger", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN10"}, }, down = iCommandPlane_HOTAS_BoatSwitchAft, up = iCommandPlane_HOTAS_BoatSwitchCenter, name = "HOTAS Boat Switch Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN9"}, }, down = iCommandPlane_HOTAS_BoatSwitchForward, up = iCommandPlane_HOTAS_BoatSwitchCenter, name = "HOTAS Boat Switch Forward", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN12"}, }, down = iCommandPlane_HOTAS_ChinaHatAft, up = iCommandPlane_HOTAS_ChinaHatOff, name = "HOTAS China Hat Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN11"}, }, down = iCommandPlane_HOTAS_ChinaHatForward, up = iCommandPlane_HOTAS_ChinaHatOff, name = "HOTAS China Hat Forward", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_D"}, }, down = iCommandPlane_HOTAS_CoolieDown, up = iCommandPlane_HOTAS_CoolieOff, name = "HOTAS Coolie Switch Down", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_L"}, }, down = iCommandPlane_HOTAS_CoolieLeft, up = iCommandPlane_HOTAS_CoolieOff, name = "HOTAS Coolie Switch Left", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_R"}, }, down = iCommandPlane_HOTAS_CoolieRight, up = iCommandPlane_HOTAS_CoolieOff, name = "HOTAS Coolie Switch Right", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_U"}, }, down = iCommandPlane_HOTAS_CoolieUp, up = iCommandPlane_HOTAS_CoolieOff, name = "HOTAS Coolie Switch Up", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN6"}, }, down = iCommandPlane_HOTAS_MIC_SwitchLeft, up = iCommandPlane_HOTAS_MIC_SwitchOff, name = "HOTAS MIC Switch Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN5"}, }, down = iCommandPlane_HOTAS_MIC_SwitchDown, up = iCommandPlane_HOTAS_MIC_SwitchOff, name = "HOTAS MIC Switch Down", category = "HOTAS"},
{combos = {{key = "JOY_BTN4"}, }, down = iCommandPlane_HOTAS_MIC_SwitchRight, up = iCommandPlane_HOTAS_MIC_SwitchOff, name = "HOTAS MIC Switch Forward", category = "HOTAS"},
{combos = {{key = "JOY_BTN3"}, }, down = iCommandPlane_HOTAS_MIC_SwitchUp, up = iCommandPlane_HOTAS_MIC_SwitchOff, name = "HOTAS MIC Switch Up", category = "HOTAS"},
...
{down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff, name = "HOTAS Nosewheel Steering Button", category = "HOTAS"},
{combos = {{key = "JOY_BTN14"}, }, down = iCommandPlane_HOTAS_PinkySwitchAft, up = iCommandPlane_HOTAS_PinkySwitchCenter, name = "HOTAS Pinky Switch Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN13"}, }, down = iCommandPlane_HOTAS_PinkySwitchForward, up = iCommandPlane_HOTAS_PinkySwitchCenter, name = "HOTAS Pinky Switch Forward", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN8"}, }, down = iCommandPlane_HOTAS_SpeedBrakeSwitchAft, up = iCommandPlane_HOTAS_SpeedBrakeSwitchCenter, name = "HOTAS Speed Brake Switch Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN7"}, }, down = iCommandPlane_HOTAS_SpeedBrakeSwitchForward, up = iCommandPlane_HOTAS_SpeedBrakeSwitchCenter, name = "HOTAS Speed Brake Switch Forward", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN26"}, }, down = iCommandPlaneAutopilot, up = iCommandPlaneAutopilot, name = "LAAP Engage/Disengage", category = "LASTE Control Panel"},
{combos = {{key = "JOY_BTN28"}, }, down = iCommandPlaneStabHbarBank, up = iCommand_LASTE_from_ALT_to_ALTHDG, name = "LAAP Mode Selector (ALT)", category = "LASTE Control Panel"},
{combos = {{key = "JOY_BTN27"}, }, down = iCommandPlaneStabPathHold, up = iCommand_LASTE_from_PATH_to_ALTHDG, name = "LAAP Mode Selector (PATH)", category = "LASTE Control Panel"},
...
{down = iCommandPlaneGearDown, name = "Landing Gear Down", category = "Landing gear panel"},
{down = iCommandPlaneGearUp, name = "Landing Gear Up", category = "Landing gear panel"},
{down = iCommandPlaneGear, name = "Landing Gear Up/Down", category = "Landing gear panel"},
{combos = {{key = "JOY_BTN21"}, }, down = iCommandPlane_LG_WRN_Silence, up = iCommandPlane_LG_WRN_Silence, name = "Landing Gear Warning Silence", category = "Engine Control Panel"},
...
{combos = {{key = "JOY_BTN16"}, }, down = iCommandPlane_L_ENG_FUEL_FLOW_Norm, up = iCommandPlane_L_ENG_FUEL_FLOW_Override, name = "Left Engine Fuel Flow Norm/Override", category = "Engine Control Panel"},
...
{combos = {{key = "JOY_BTN18"}, }, down = iCommandPlane_L_ENG_OPER_Motor, up = iCommandPlane_L_ENG_OPER_Norm_from_Motor, name = "Left Engine Oper Motor / Norm", category = "Engine Control Panel"},
{down = iCommand_FireExting_LeftEngineExting, name = "Left Engine T-Handle Fire Extinguisher", category = "Fire Extinguishers System"},
{combos = {{key = "JOY_BTN30"}, }, down = iCommandLeftEngineStop, up = iCommandLeftEngineStart, name = "Left Engine Throttle Set OFF", category = "Systems"},
...
{down = iCommandPlaneLightsOnOff, name = "Navigation lights", category = "Systems"},
...
{combos = {{key = "JOY_BTN25"}, }, down = iCommandPlane_RDR_ALTM_NRM, up = iCommandPlane_RDR_ALTM_DIS, name = "RDR ALTM Normal/Disable", category = "LASTE Control Panel"},
...
{combos = {{key = "JOY_BTN17"}, }, down = iCommandPlane_R_ENG_FUEL_FLOW_Norm, up = iCommandPlane_R_ENG_FUEL_FLOW_Override, name = "Right Engine Fuel Flow Norm/Override", category = "Engine Control Panel"},
{combos = {{key = "JOY_BTN32"}, }, down = iCommandPlane_R_ENG_OPER_Ign, up = iCommandPlane_R_ENG_OPER_Norm_from_Ign, name = "Right Engine Oper Ign / Norm", category = "Engine Control Panel"},
{combos = {{key = "JOY_BTN19"}, }, down = iCommandPlane_R_ENG_OPER_Motor, up = iCommandPlane_R_ENG_OPER_Norm_from_Motor, name = "Right Engine Oper Motor / Norm", category = "Engine Control Panel"},
...
{combos = {{key = "JOY_BTN29"}, }, down = iCommandRightEngineStop, up = iCommandRightEngineStart, name = "Right Engine Throttle Set OFF", category = "Systems"},
...
{down = iCommandLampsControl, up = iCommandLampsControl_up, name = "Signal lights lamp test", category = "Auxiliary lighting control panel"},
...
{down = iCommandThrottleDecrease, up = iCommandThrottleStop, name = "Throttle Both Down", category = "Flight Control"},
{down = iCommandThrottleIncrease, up = iCommandThrottleStop, name = "Throttle Both Up", category = "Flight Control"},
...
{combos = {{key = "JOY_BTN22"}, }, down = iCommandPlane_FLAPS_UP, up = iCommandPlane_FLAPS_MNR_from_UP, name = "Toggle Flaps Up", category = "Systems"},
...
{down = iCommandPlaneTrimCancel, name = "Trim: Reset", category = "HOTAS"},
...
{down = iCommandPlaneUFC_MASTER_WARNING, up = iCommandPlaneUFC_MASTER_WARNING, name = "UFC Master Caution Key", category = "UFC"},
...
{pressed = iCommandViewCenter, name = "View Center", category = "View"},
{pressed = iCommandViewDownLeftSlow, up = iCommandViewStopSlow, name = "View Down Left slow", category = "View"},
{pressed = iCommandViewDownRightSlow, up = iCommandViewStopSlow, name = "View Down Right slow", category = "View"},
{pressed = iCommandViewDownSlow, up = iCommandViewStopSlow, name = "View Down slow", category = "View"},
{pressed = iCommandViewLeftSlow, up = iCommandViewStopSlow, name = "View Left slow", category = "View"},
{pressed = iCommandViewRightSlow, up = iCommandViewStopSlow, name = "View Right slow", category = "View"},
{pressed = iCommandViewUpLeftSlow, up = iCommandViewStopSlow, name = "View Up Left slow", category = "View"},
{pressed = iCommandViewUpRightSlow, up = iCommandViewStopSlow, name = "View Up Right slow", category = "View"},
{pressed = iCommandViewUpSlow, up = iCommandViewStopSlow, name = "View Up slow", category = "View"},
{down = iCommandViewAll, name = "View all mode", category = "View Extended"},
{down = iCommandViewBriefing, name = "View briefing on/off", category = "General"},
...
{down = iCommandPlanePickleOn, up = iCommandPlanePickleOff, name = "Weapon release", category = "HOTAS"},
...
{pressed = iCommandPlaneTrimLeftRudder, name = "Yaw Trim Left", category = "Stability Augmentation System"},
{pressed = iCommandPlaneTrimRightRudder, name = "Yaw Trim Right", category = "Stability Augmentation System"},
...
{combos = {{key = "JOY_X", filter = {saturationX = 1, saturationY = 0.15, deadzone = 0.3, invert = false, slider = false, curvature = {0}}}, }, action = iCommandPlaneSelecterHorizontalAbs, name = "HOTAS Slew Horizontal"},
{combos = {{key = "JOY_Y", filter = {saturationX = 1, saturationY = 0.15, deadzone = 0.3, invert = false, slider = false, curvature = {0}}}, }, action = iCommandPlaneSelecterVerticalAbs, name = "HOTAS Slew Vertical"},
...
{combos = {{key = "JOY_RZ"}, }, action = iCommandPlaneThrustLeft, name = "Throttle Left"},
{combos = {{key = "JOY_Z"}, }, action = iCommandPlaneThrustRight, name = "Throttle Right"},
...
{combos = {{key = "JOY_SLIDER1"}, }, action = iCommandViewZoomAbs, name = "Zoom View"},
},
}
end