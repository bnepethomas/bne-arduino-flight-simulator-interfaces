...
{combos = {{key = "JOY_BTN6"}, }, down = iCommandPlane_HOTAS_TriggerSecondStage, up = iCommandPlane_HOTAS_TriggerSecondStage_Off, name = "Gun Trigger", category = "HOTAS"},
{combos = {{key = "JOY_BTN1"}, }, down = iCommandPlane_HOTAS_TriggerFirstStage, up = iCommandPlane_HOTAS_TriggerFirstStage_Off, name = "Gun Trigger (first stage)", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN17"}, }, down = iCommandPlane_HOTAS_CMS_Down, up = iCommandPlane_HOTAS_CMS_Off, name = "HOTAS CMS Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN15"}, }, down = iCommandPlane_HOTAS_CMS_Up, up = iCommandPlane_HOTAS_CMS_Off, name = "HOTAS CMS Forward", category = "HOTAS"},
{combos = {{key = "JOY_BTN18"}, }, down = iCommandPlane_HOTAS_CMS_Left, up = iCommandPlane_HOTAS_CMS_Off, name = "HOTAS CMS Left", category = "HOTAS"},
{combos = {{key = "JOY_BTN16"}, }, down = iCommandPlane_HOTAS_CMS_Right, up = iCommandPlane_HOTAS_CMS_Off, name = "HOTAS CMS Right", category = "HOTAS"},
{combos = {{key = "JOY_BTN19"}, }, down = iCommandPlane_HOTAS_CMS_Zaxis, up = iCommandPlane_HOTAS_CMS_Zaxis_Off, name = "HOTAS CMS Z Axis", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN13"}, }, down = iCommandPlane_HOTAS_DataManagementSwitchDown, up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = "HOTAS DMS Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN11"}, }, down = iCommandPlane_HOTAS_DataManagementSwitchUp, up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = "HOTAS DMS Forward", category = "HOTAS"},
{combos = {{key = "JOY_BTN14"}, }, down = iCommandPlane_HOTAS_DataManagementSwitchLeft, up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = "HOTAS DMS Left", category = "HOTAS"},
{combos = {{key = "JOY_BTN12"}, }, down = iCommandPlane_HOTAS_DataManagementSwitchRight, up = iCommandPlane_HOTAS_DataManagementSwitchOff, name = "HOTAS DMS Right", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN5"}, }, down = iCommandPlane_HOTAS_MasterModeControlButton, up = iCommandPlane_HOTAS_MasterModeControlButtonUP, name = "HOTAS Master Mode Control Button", category = "HOTAS"},
{combos = {{key = "JOY_BTN3"}, }, down = iCommandPlane_HOTAS_NoseWheelSteeringButton, up = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff, name = "HOTAS Nosewheel Steering Button", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN9"}, }, down = iCommandPlane_HOTAS_TargetManagementSwitchDown, up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = "HOTAS TMS Aft", category = "HOTAS"},
{combos = {{key = "JOY_BTN7"}, }, down = iCommandPlane_HOTAS_TargetManagementSwitchUp, up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = "HOTAS TMS Forward", category = "HOTAS"},
{combos = {{key = "JOY_BTN10"}, }, down = iCommandPlane_HOTAS_TargetManagementSwitchLeft, up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = "HOTAS TMS Left", category = "HOTAS"},
{combos = {{key = "JOY_BTN8"}, }, down = iCommandPlane_HOTAS_TargetManagementSwitchRight, up = iCommandPlane_HOTAS_TargetManagementSwitchOff, name = "HOTAS TMS Right", category = "HOTAS"},
...
{combos = {{key = "JOY_BTN_POV1_L", reformers = {"LCtrl", }}, }, pressed = iCommandPlaneTrimLeft, up = iCommandPlaneTrimStop, name = "Trim: Left Wing Down", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_U", reformers = {"LCtrl", }}, }, pressed = iCommandPlaneTrimUp, up = iCommandPlaneTrimStop, name = "Trim: Nose Down", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_D", reformers = {"LCtrl", }}, }, pressed = iCommandPlaneTrimDown, up = iCommandPlaneTrimStop, name = "Trim: Nose Up", category = "HOTAS"},
{down = iCommandPlaneTrimCancel, name = "Trim: Reset", category = "HOTAS"},
{combos = {{key = "JOY_BTN_POV1_R", reformers = {"LCtrl", }}, }, pressed = iCommandPlaneTrimRight, up = iCommandPlaneTrimStop, name = "Trim: Right Wing Down", category = "HOTAS"},
