...
{combos = {{key = "JOY_BTN1"}, }, down = iCommandPlaneWheelBrakeLeftOn, up = iCommandPlaneWheelBrakeLeftOff, name = "Wheel Brake Left On/Off", category = "Systems"},
{down = iCommandPlaneWheelBrakeOn, up = iCommandPlaneWheelBrakeOff, name = "Wheel Brake On/Off", category = "Systems"},
{combos = {{key = "JOY_BTN2"}, }, down = iCommandPlaneWheelBrakeRightOn, up = iCommandPlaneWheelBrakeRightOff, name = "Wheel Brake Right On/Off", category = "Systems"},
...
{combos = {{key = "JOY_RZ"}, {key = "JOY_RX"}, }, action = iCommandPlaneRudder, name = "Rudder"},
